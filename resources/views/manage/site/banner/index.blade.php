                        ...
                        <form method="Post" class="form-inline">
                            <table class="table table-bordered table-hover  table-condensed">
                                ...
                                <tr style="text-align: center" class="text-center">
                                    ...
                                    <th><a href="">所属客户</a></th>
                                    <th style="width: 60px;"><a href="">姓名</a></th>
                                    <th style="width: 60px;"><a href="">性别</a></th>
                                    <th style="width: 100px;"><a href="">手机号</a></th>
                                    <th style="width: 80px;"><a href="">QQ</a></th>
                                    <th style="width: 160px;"><a href="">邮箱</a></th>
                                    <th><a href="">备注</a></th>
                                ...
                                <tr v-for="item in list.data">
                                    ...
                                    <td style="text-align: center" v-text="item.sex_cn"></td>
        ...
        var vm = new Vue({
            ...
            methods: {
                init: function () {
                    var _self = this;
                    //加载数据
                    this.$http.get("{{url('/manage/crm/customer/linkman?json')}}", {params: this.params})
                ...
                create: function () {
                    openUrl('{{url('/manage/crm/customer/linkman/create')}}', '新增联系人', 800, 600);
                },
                edit: function (item) {
                    this.linkman = item;
                    openUrl('{{url('/manage/crm/customer/linkman/edit')}}' + '?id=' + item.id, '编辑"' + item.name + '"联系人', 800, 600);
                },
                state: function (item) {
                    var _self = this;
                    this.linkman = item;
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '{{url('/manage/crm/customer/linkman/edit')}}',
                        data: _self.linkman,
                        headers: {
                ...
                delete: function (ids) {
                    ...
                    layer.confirm('确认删除吗？', {
                        ...
                        _self.$http.post("{{url('/manage/crm/customer/linkman/delete')}}", {ids: ids})
                                .then(function (response) {
                                            if (response.data.code == 0) {
                                                _self.init();
                                                layer.closeAll();
